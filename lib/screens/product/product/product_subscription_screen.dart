...
class ProductSubscriptionDetailScreen extends StatefulWidget {
  final String product_id,product_name;
  const ProductSubscriptionDetailScreen({Key key, @required this.product_id, @required this.product_name}) : super(key: key);
  // UserNotSubscriptionProductScreenState createState() => UserNotSubscriptionProductScreenState();
  State<ProductSubscriptionDetailScreen> createState() => ProductSubscriptionDetailScreenState(product_id,product_name);

  // @override
  // _ProductSubscriptionDetailScreenState createState() => _ProductSubscriptionDetailScreenState();
}

class ProductSubscriptionDetailScreenState extends State<ProductSubscriptionDetailScreen> {
  BuildContext _ctx;

  String product_id,product_name;
  ProductSubscriptionDetailScreenState(this.product_id,this.product_name);
                                                          ...
                                                          children: [
                                                            ...
                                                            Container(
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child: Row(
                                                                    children: [
                                                                      Text("Choose Delivery Schedule", style: TextStyle(color: textcolor,fontSize: textSizeSmall, fontWeight: FontWeight.w700, letterSpacing: 0.5)),
                                                                    ],
                                                                  ),
                                                                )
                                                            ),
                                                              ...
                                                              children: [
                                                                InkWell(
                                                                  ...
                                                                  Container(
                                                                      ...
                                                                      child: Padding(
                                                                        padding: const EdgeInsets.fromLTRB(15, 7, 15, 7),
                                                                        child: Text("Everyday", style: TextStyle(color: maincolor,fontSize: textSizeSmall, fontWeight: FontWeight.w400, letterSpacing: 0.5)),
                                                                      )),
                                                                ),
                                                              ],
                                                            ),
                            ...
                            Container(
                              ...
                              child:  InkWell(
                                onTap: () {
                                  if(day==0)
                                  {
                                    // FlashHelper.errorBar(context, message: DateFormat('yyyy-MM-dd').format(mordate).toString(),);
                                    if(count < product_min_qty)
                                    {
                                      showDialog(
                                          context: context,
                                      ...
                                      if (_isProccessing == false) {
                                        ...
                                        if (form.validate()) {
                                          ...
                                          _netUtil.post(RestDatasource.ORDER, body: {
                                            'action': "order_everyday_subscription_product",
                                            "user_id": user_id,
                                            "product_id": product_id,
                                            "product_name": product_name,
