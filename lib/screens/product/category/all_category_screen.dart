                                    ...
                                    children: <Widget>[
                                      ...
                                      InkWell(onTap:(){
                                        Navigator.of(context).pushNamed("/allproduct",
                                          ...
                                          child: (data.category_img != null) ?ClipRRect(borderRadius: BorderRadius.circular(8.0),child: new Image.network(RestDatasource.CATEGORY_IMAGE + data.category_img, width: 90, height: 90,)):ClipOval(child: new Image.asset('images/logo.png', width: 90, height: 90,))),
                                      SizedBox(
                                        width: 10,
                                      ),
                                      Flexible(
                                            ...
                                            Flexible(
                                              child: Column(
                                                children: [
                                                  ...
                                                  Text(
                                                    data.category_name,
                                                    style: TextStyle(fontSize: 20,fontWeight: FontWeight.w600, color: blackcolor),
                                                  ),
                                                  // SizedBox(
                                                  //   height: 10,
                                                  // ),
